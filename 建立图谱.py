...
with open('C:\\Users\\cuguanren\pytorch实践项目\\基于知识图谱的电影问答系统\\data\\genre.csv','r',encoding='utf-8') as f:
...
with open('C:\\Users\\cuguanren\pytorch实践项目\\基于知识图谱的电影问答系统\\data\\movie.csv','r',encoding='utf-8') as f:
    reader=csv.reader(f)
    for item in reader:
        #第一行的标签不是需要的内容，line_num表示文件的第几行
        if reader.line_num==1:
...
with open('C:\\Users\\cuguanren\pytorch实践项目\\基于知识图谱的电影问答系统\\data\\person.csv','r',encoding='utf-8') as f:
    #数据集除了第一行代表属性外，第一列为实体1，第二列为实体2，第三列是两者英文关系，第四列为两者中文关系
    reader=csv.reader(f)
    for item in reader:
        #第一行的标签不是需要的内容，line_num表示文件的第几行
...
print(findnode)
with open('C:\\Users\\cuguanren\pytorch实践项目\\基于知识图谱的电影问答系统\\data\\person_to_movie.csv','r',encoding='utf-8') as f:
    #数据集除了第一行代表属性外，第一列为实体1，第二列为实体2，第三列是两者英文关系，第四列为两者中文关系
    reader=csv.reader(f)
    for item in reader:
...
with open('C:\\Users\\cuguanren\pytorch实践项目\\基于知识图谱的电影问答系统\\data\\movie_to_genre.csv', 'r', encoding='utf-8') as f:
    #数据集除了第一行代表属性外，第一列为实体1，第二列为实体2，第三列是两者英文关系，第四列为两者中文关系
    reader=csv.reader(f)
    for item in reader:
        #第一行的标签不是咱们需要的内容，line_num表示文件的第几行
